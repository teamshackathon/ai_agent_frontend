...
class TeacherActivityPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final noticeStream = ref.watch(noticeTeacherGetProvider);
    ...
    return BasePage(
      ...
      body: noticeStream.when(
        ...
        data: (snapshot) {
          ...
          } else if (filter.value == "student") {
            notices
                .removeWhere((notice) => notice.data().publisher != "student");
                  ...
                  child: SingleChildScrollView(
                      ...
                      child: Flex(
                        ...
                        children: [
                          ...
                          ActivitySelectableFilterButton(
                            selected: filter.value == "student",
                            child: Text('生徒からの通知'),
                            onPressed: () => {filter.value = "student"},
                          ),
                          ActivitySelectableFilterButton(
