...
mixin _$Teacher {
  ...
  String get name =>
      throw _privateConstructorUsedError; // [ { "room": "~", "year": "~", "subject": "~" }, ... ]
  List<Map<String, String>> get teach => throw _privateConstructorUsedError;
...
abstract class $TeacherCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Map<String, String>> teach});
}
...
class _$TeacherCopyWithImpl<$Res, $Val extends Teacher>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      teach: null == teach
          ? _value.teach
          : teach // ignore: cast_nullable_to_non_nullable
...
class _$TeacherImpl extends _Teacher {
  const _$TeacherImpl(
      {required this.id,
      required this.name,
      required final List<Map<String, String>> teach})
      : _teach = teach,
        super._();
  ...
  final String name;
// [ { "room": "~", "year": "~", "subject": "~" }, ... ]
  final List<Map<String, String>> _teach;
// [ { "room": "~", "year": "~", "subject": "~" }, ... ]
  @override
  List<Map<String, String>> get teach {
    if (_teach is EqualUnmodifiableListView) return _teach;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_teach);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._teach, _teach));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(
      runtimeType, id, name, const DeepCollectionEquality().hash(_teach));
...
abstract class _Teacher extends Teacher {
  const factory _Teacher(
      ...
      required final List<Map<String, String>> teach}) = _$TeacherImpl;
  ...
  String get id;
  @override
  String get name; // [ { "room": "~", "year": "~", "subject": "~" }, ... ]
  @override
  List<Map<String, String>> get teach;
